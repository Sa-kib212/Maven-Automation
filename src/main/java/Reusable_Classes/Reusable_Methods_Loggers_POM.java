...
public class Reusable_Methods_Loggers_POM {
    ...
    public static void click(WebDriver driver, ExtentTest logger, WebElement locator, int index, String elementName) throws IOException {
        WebDriverWait wait = new WebDriverWait(driver, timeOut);
        System.out.println("Clicking on element " + elementName);
        logger.log(LogStatus.INFO,"Clicking on element" + elementName);
        try {
            WebElement element = wait.until(ExpectedConditions.visibilityOfAllElements(locator)).get(index);
            element.click();
    ...
    public static void sendKeys(WebDriver driver, ExtentTest logger, WebElement locator, int index, String userInput, String elementName) throws IOException {
        WebDriverWait wait = new WebDriverWait(driver, timeOut);
    ...
    public static void mouseHover(WebDriver driver, ExtentTest logger, WebElement locator, int index, String elementName) throws IOException {
        WebDriverWait wait = new WebDriverWait(driver, timeOut);
