...
public class Express_Action_Item_Loggers<softassert> extends Reusable_Methods_Loggers {
    ...
    jse = (JavascriptExecutor)driver;
        ...
        report = new ExtentReports("src/main/java/Report_Folder/Express_Checkout.html",true);
    ...
    @Test
    public void test() throws InterruptedException, WriteException, IOException {
    ...
    public void afterTest() throws IOException, WriteException {
            //Flush the loggers to the report
        report.flush();
            //Closing the report
        report.close();
